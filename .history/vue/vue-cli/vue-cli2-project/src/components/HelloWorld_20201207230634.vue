<template>
  <div class="hello">
    ...
    <div class="t" id="test1">use</div>
    <div class="t">test1</div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    //   const fs = require('fs')
    //   debugger
    //   let a = 'C://Users//jjj//AppData//Roaming//Electron//localFile//8207e7ea-524a-41af-b961-eba35f2fab94//22.doc'
    //   fs.open(a, function (err, fd) {
    //     if (err) {
    //       throw err
    //     }
